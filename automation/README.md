...
3. DeepSeek classifies direct relevance, supplies a required method or index short name, assigns topic, production-stage, output-type, production-control, and input-track labels, writes short English and Chinese summaries, and makes a conservative AI Highlight assessment under the website taxonomy.
